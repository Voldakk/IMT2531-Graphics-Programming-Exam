...
void Shader::SetUniforms(Scene* scene, Transform* transform, Material* material)
{
...
void StandardShader::SetUniforms(Scene * scene, Transform * transform, Material * material)
{
	if (id != activeShader)
	{
		activeShader = id;
...
StandardInstancedShader::StandardInstancedShader()
{
	id = ShaderLoad::CreateProgram("standard_instanced.vert", "standard_instanced.frag");
...
void StandardInstancedShader::SetUniforms(Scene* scene, Transform* transform, Material* material)
{
	if (id != activeShader)
	{
		activeShader = id;
	...
	// Material
	if (material != Material::activeMaterial)
	{
		glUseProgram(id);
...
void UnlitTextureShader::SetUniforms(Scene * scene, Transform * transform, Material * material)
{
	if (id != activeShader)
	{
		activeShader = id;
...
UnlitTextureInstancedShader::UnlitTextureInstancedShader()
{
	id = ShaderLoad::CreateProgram("unlit_texture_instanced.vert", "unlit_texture_instanced.frag");

	viewId = glGetUniformLocation(id, "view");
	projectionId = glGetUniformLocation(id, "projection");
}

void UnlitTextureInstancedShader::SetUniforms(Scene* scene, Transform* transform, Material* material)
{
	if (id != activeShader)
	{
		activeShader = id;
...
void SkyboxShader::SetUniforms(Scene * scene, Transform * transform, Material * material)
{
	if (id != activeShader)
	{
		activeShader = id;
